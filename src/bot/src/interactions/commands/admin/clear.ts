...
import { CommandInteraction, CacheType, CommandInteractionOption, ChannelResolvable, TextChannel } from 'discord.js';
...
export default class ClearCommand extends BaseCommand {
    ...
    async execute(bot: bot, interaction: CommandInteraction<CacheType>, options: readonly CommandInteractionOption<CacheType>[]): Promise<void> {
        var amount = options[0].value as number;
